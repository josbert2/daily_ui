(self["webpackChunkwenly"] = self["webpackChunkwenly"] || []).push([["js/app"],{
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'core-js/modules/es.array.filter.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'core-js/modules/es.string.starts-with.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony import */ var tailwindcss_resolveConfig__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tailwindcss/resolveConfig */ "./node_modules/tailwindcss/resolveConfig.js");
/* harmony import */ var tailwindcss_resolveConfig__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(tailwindcss_resolveConfig__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_dragElements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/dragElements */ "./web/assets/encore/js/vendor/dragElements.js");
/* harmony import */ var _vendor_clickElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/clickElement */ "./web/assets/encore/js/vendor/clickElement.js");
/* harmony import */ var _vendor_addEvento__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vendor/addEvento */ "./web/assets/encore/js/vendor/addEvento.js");
/* harmony import */ var _vendor_hoverElement__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./vendor/hoverElement */ "./web/assets/encore/js/vendor/hoverElement.js");
/* harmony import */ var _vendor_disabledEnabled__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./vendor/disabledEnabled */ "./web/assets/encore/js/vendor/disabledEnabled.js");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-browser/v1.js");
/* harmony import */ var _tailwindJSON_textColor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tailwindJSON/textColor */ "./web/assets/encore/js/tailwindJSON/textColor.js");
...
var dataMaster = [];
var fullConfigTW = tailwindcss_resolveConfig__WEBPACK_IMPORTED_MODULE_2___default()((_tailwind_config__WEBPACK_IMPORTED_MODULE_1___default()));
var userConfigTW = (_tailwind_config__WEBPACK_IMPORTED_MODULE_1___default()); //dataMaster.push(textColor(fullConfigTW, dataMaster))
...
addEvent(document, 'click', '.select-item', function (e) {
  ...
  var semiColor = '';
  prefixBreakpoint.forEach(function (prefix) {
...
addEvent(document, 'click', '.active-inspect', function () {
  initTW();
  setTimeout(function () {
    (0,_vendor_addEvento__WEBPACK_IMPORTED_MODULE_5__.addE)();
    (0,_vendor_hoverElement__WEBPACK_IMPORTED_MODULE_6__.hoverElement)();
    (0,_vendor_clickElement__WEBPACK_IMPORTED_MODULE_4__.clickElement)();
    (0,_vendor_dragElements__WEBPACK_IMPORTED_MODULE_3__.dragElement)(document.getElementById("mydiv"));
    space();
    JSONDATA();
...
var textColor = function textColor(fullConfigTW, data) {
  var prefixBreakpoint = [];
  Object.entries(fullConfigTW.theme.screens).forEach(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];
  ...
  var dataPush = [];
  Object.entries(fullConfigTW.theme.colors).forEach(function (_ref3) {
    var _ref4 = _slicedToArray(_ref3, 2),
        keys = _ref4[0],
        value = _ref4[1];

    if (typeof value === 'string') {
      prefixBreakpoint.forEach(function (screen) {
        data.push(screen + ':text-' + keys);
      });
      data.push('text-' + keys);
    }

    if (_typeof(value) === 'object') {
      Object.entries(value).forEach(function (_ref5, index) {
        var _ref6 = _slicedToArray(_ref5, 2),
            key = _ref6[0],
            value = _ref6[1];

        prefixBreakpoint.forEach(function (screen) {
          data.push(screen + ':text-' + keys + '-' + key);
        });
...
/******/ __webpack_require__.O(0, ["vendors-node_modules_autoprefixer_lib_autoprefixer_js-node_modules_tailwindcss_resolveConfig_-293381"], () => (__webpack_exec__("./web/assets/encore/js/app.js")));
